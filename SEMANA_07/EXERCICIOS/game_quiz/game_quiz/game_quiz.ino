...
const char *ssid = "redmi9"; //Digite o nome da sua rede aqui
const char *password = "12345678"; //Digite a senha da rede, deve conter no mínimo 8 caractéres se não dá erro.
